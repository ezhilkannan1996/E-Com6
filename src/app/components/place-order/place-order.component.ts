...
import { cart, ShippingDetails } from 'src/app/interface/data-type';
...
export class PlaceOrderComponent {
  ...
  submitOrder() {
    console.log('Order submitted:', this.shippingDetails);
  }
